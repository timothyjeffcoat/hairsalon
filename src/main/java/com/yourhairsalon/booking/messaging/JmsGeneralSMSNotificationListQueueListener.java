...
public class JmsGeneralSMSNotificationListQueueListener {
	private static final Log log = LogFactory.getLog(JmsGeneralSMSNotificationListQueueListener.class);
    ...
    private void sendTextMessage(String SMS_TO, String SMS_TEXT){
    	...
    	SMS_TO = SMS_TO.replaceAll("[^\\d.]", "");
    	log.debug("client's cell phone SMS_TO: "+SMS_TO);
    ...
    public void onMessage(Object message) {
    	...
    	log.debug("ENTERED JmsGeneralSMSNotificationListQueueListener onMessage");
        ...
        log.debug("sms to: "+appt.getShop_sms_to());
        log.debug("sms message: "+appt.getShop_sms_message());
        ...
        log.debug("EXITING JmsGeneralSMSNotificationListQueueListener onMessage");
    }
